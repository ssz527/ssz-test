...
/*
	初始化地图参数解释 
	{
		...
		mapUrl:"map.jpg"   //地图地图的url，如果为光栅图，此处为图片的url，如果为百度地图，则需要根据sat来判断，sat为0时，此处的url为'http://online1.map.bdimg.com/onlinelabel/?qt=tile&x={x}&y={y}&z={z}&styles=pl&p=1&scaler=1&udt=20171115'
						   //当sat为1时，此处的url为'http://shangetu1.map.bdimg.com/it/u=x={x};y={y};z={z};v=009;type=sate&fm=46&app=webearth2&v=009&udt=20171115';
